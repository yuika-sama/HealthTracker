...
object DefaultCatalogData
{
    fun foods(userId: Int) = listOf(
        ...
        FoodCatalog(userId = userId, name = "Yogurt", caloriesPerServing = 100, defaultQuantity = 1f, unit = "cup"),
        FoodCatalog(userId = userId, name = "Oatmeal", caloriesPerServing = 150, defaultQuantity = 40f, unit = "g"),
        FoodCatalog(userId = userId, name = "Bread", caloriesPerServing = 80, defaultQuantity = 1f, unit = "slice"),
        FoodCatalog(userId = userId, name = "Cheese", caloriesPerServing = 113, defaultQuantity = 1f, unit = "slice"),
        FoodCatalog(userId = userId, name = "Peanut butter", caloriesPerServing = 188, defaultQuantity = 2f, unit = "tbsp"),
        ...
        FoodCatalog(userId = userId, name = "Black coffee", caloriesPerServing = 2, defaultQuantity = 1f, unit = "cup"),
        FoodCatalog(userId = userId, name = "Bubble tea", caloriesPerServing = 450, defaultQuantity = 1f, unit = "cup"),
        FoodCatalog(userId = userId, name = "Pizza slice", caloriesPerServing = 285, defaultQuantity = 1f, unit = "slice")
    )
