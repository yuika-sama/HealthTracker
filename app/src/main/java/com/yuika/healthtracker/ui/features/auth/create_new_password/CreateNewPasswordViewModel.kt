...
)
{
    ...
    private fun handleResetPassword()
    {
        ...
        launchSafe (
            onError = { throwable ->
                updateState { it.copy(isLoading = false, errorMessage = throwable.message ?: "An unexpected error occurred") }
                sendEffect(CreateNewPasswordEffect.ShowToast(throwable.message ?: "An unexpected error occurred"))
            }
        ) {
